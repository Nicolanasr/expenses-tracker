...
export function SignUpForm() {
  ...
  return (
    <form action={formAction} className="space-y-5">
      ...
      <button
        type="submit"
        className="inline-flex h-11 w-full items-center justify-center rounded-lg bg-indigo-600 px-3 text-sm font-semibold text-white transition hover:bg-indigo-500"
      >
        Create account
      </button>
      ...
      <p className="text-xs text-slate-600">
        Already registered?{' '}
        <Link href="/auth/sign-in" className="font-semibold text-indigo-600">
          Sign in
        </Link>
      </p>
    </form>
