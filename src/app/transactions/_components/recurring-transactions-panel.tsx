    ...
    <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex flex-col gap-2">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-base font-semibold text-slate-900">Recurring transactions history</h2>
            <p className="text-sm text-slate-500">Upcoming schedules that auto-log or require approval.</p>
          </div>
          <button
            type="button"
